...
<html lang="en">
   ...
   <p>20301/NP-101/16 </p>
      ...
      <div id="leftdivcontainer" class="clearfix"   >
         ...
         <div style="font-family: dejavusans;" style="font-size: 7pt" class="leftdiv2" id="light-table-paragraph"><input type="checkbox" style="-webkit-transform: scale(2);" style="height:30px;" id="coding" name="interest" value="coding" />&nbsp; Baja por renuncia
            <br>
         ...
         <div style="font-family: dejavusans;" style="font-size: 7pt" class="leftdiv3" id="light-table-paragraph"><input type="checkbox" id="coding" name="interest" value="coding" />&nbsp; Baja por inhabilitación
            <br>
            ...
            <br>          
            <input type="checkbox" id="coding" name="interest" value="coding" />&nbsp; Otro Especificar: PAGO DE NÓMINA DE PERSONAL EVENTUAL
         </div>
      </div>
      ...
      <h4 id="tabla1">Partida Presupuestal: 126 010804010101 11010101 20706006000000L 1222 5100</h4>
         ...
         <div>
            ...
            <div   style="font-size: 8pt" tyle="float:left;width: 2%;outline: red solid thin">
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C.P. MARTHA BEATRIZ ARISTA 
               <div>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; VÁZQUEZ 
               </div>
         ...
         <div>
            ...
            <div style="float:left;width: 3%;outline: red solid thin" style="font-size: 8pt">
               MTRO. RODOLFO ALEJANDRO LÓPEZ 
               &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;VIDEZ
               <div>
